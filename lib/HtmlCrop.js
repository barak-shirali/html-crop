...
/***/ function(module, exports, __webpack_require__) {
	...
	var HtmlCrop = function (_BaseObject) {
	  ...
	  function HtmlCrop(doc) {
	    ...
	    (0, _html2canvas2.default)(_this._document.html).then(function (canvas) {
	      // const dataURL = canvas.toDataURL('image/png');
	      // window.location.href = dataURL; // eslint disable-line
	
	      _this._canvas = canvas;
	
	      var selectionCanvas = doc.createElement('canvas');
	      _this._selectionCanvas = selectionCanvas;
	      ...
	      _this._document.body.appendChild(selectionCanvas);
	      _this._canvasState = new _canvasState2.default(doc, selectionCanvas, _this._debugMode);
	  ...
	  _createClass(CanvasState, [{
	    ...
	    value: function _initEvents() {
	      ...
	      _canvas.addEventListener('mousedown', function (e) {
	        ...
	        _this2._currentHandle = _this2._shape.getHoverSelectionHandle(mouse.x, mouse.y);
	      }, true);
	      ...
	      _canvas.addEventListener('mousemove', function (e) {
	        ...
	        if (_this2._currentHandle !== false) {
	          // Handles resizing
	          switch (_this2._currentHandle) {
	            case 0:
	              _shape._x = mx;
	              _shape._y = my;
	              _shape._w += oldx - mx;
